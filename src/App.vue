<template>
    <div class="view login" v-if="state.username==='' || state.username===null">
      <form action="" class="login-form" @submit.prevent="Login">
        ...
        <input type="text" v-model="inputUsername" placeholder="Kullanıcı adınızı giriniz" id=""/>
      ...
      <h1>Hoşgeldiniz, {{ state.username }}</h1>
       ...
       <footer>
         <form @submit.prevent="SendMessage">
           <input type="text" v-model="inputMessage"  placeholder="Bir mesaj yazın..." />
